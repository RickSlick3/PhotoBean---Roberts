...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture originalKick = new Picture("kick.jpg");
    Picture skinnyKick = originalKick.scale(0.25, 0.25);
    skinnyKick.write("skinnyKick.jpg");
    Picture pix = new Picture("skinnyKick.jpg");
    pix.explore();
  }
